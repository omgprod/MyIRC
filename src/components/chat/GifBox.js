...
class GifBox extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            GIFs : [],
            offset : 0,
            message : 'Entrer un mot spécifique a votre recherche'
        }
    }
    ...
    onKeyUp(e){
        if (e.key === 'Enter') {
            if(this.state.query.length){
                ...
                alert('Entrer un mot spécifique a votre recherche');
            }
        }
    }
            ...
            <div className="gifbox col-xs-12 col-sm-12 col-md-8 col-lg-10">
                <div className="input-group">
                    <div className="input-group-prepend">
                        ...
                        >
                            <i className="fa fa-comment"/> Textuel
                        </button>
                    </div>
                    <input
